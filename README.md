...
<div align="start">
  ...
  <p>
    <img src="./assets/about-me.png" alt="Ilustração de um cérebro" align="left" width="200px" style="margin-right: 30px;" />
    <span> 
  ...
  <p>
   <b>Como penso sobre rotina:</b> se algo leva mais de ~10 minutos por dia e sempre é do mesmo jeito, prefiro investir uma vez em script, bot ou pipeline e deixar a máquina cuidar do resto.
  </p>
</div>
...
<div align="start">
 ...
 ## 🚀 Tecnologias & Ferramentas</h2>

<p>
  Minha stack é focada em produtividade e consistência do ambiente. Trabalho principalmente com TypeScript no ecossistema Web, além de usar Python e Java quando o projeto pede automação ou mais robustez. Para dados, utilizo MySQL, PostgreSQL e MongoDB.
</p>
<p>
  No dia a dia, uso Git com Conventional Commits, Docker para ambientes reproduzíveis e ferramentas como Figma e Postman no fluxo de desenvolvimento. A ideia é simples: ir da ideia ao deploy com o mínimo de fricção.
</p>
<div>
